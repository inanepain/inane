 ...
 * StatusCode
 * 
 * @method static StatusCode CONTINUE()
 * @method static StatusCode SWITCHING_PROTOCOLS()
 * @method static StatusCode PROCESSING()
 * @method static StatusCode OK()
 * @method static StatusCode CREATED()
 * @method static StatusCode ACCEPTED()
 * @method static StatusCode NON_AUTHORITATIVE_INFORMATION()
 * @method static StatusCode NO_CONTENT()
 * @method static StatusCode RESET_CONTENT()
 * @method static StatusCode PARTIAL_CONTENT()
 * @method static StatusCode MULTI_STATUS()
 * @method static StatusCode ALREADY_REPORTED()
 * @method static StatusCode IM_USED()
 * @method static StatusCode MULTIPLE_CHOICES()
 * @method static StatusCode MOVED_PERMANENTLY()
 * @method static StatusCode FOUND()
 * @method static StatusCode SEE_OTHER()
 * @method static StatusCode NOT_MODIFIED()
 * @method static StatusCode USE_PROXY()
 * @method static StatusCode SWITCH_PROXY()
 * @method static StatusCode TEMPORARY_REDIRECT()
 * @method static StatusCode PERMANENT_REDIRECT()
 * @method static StatusCode RESUME_INCOMPLETE()
 * @method static StatusCode BAD_REQUEST()
 * @method static StatusCode UNAUTHORIZED()
 * @method static StatusCode PAYMENT_REQUIRED()
 * @method static StatusCode FORBIDDEN()
 * @method static StatusCode NOT_FOUND()
 * @method static StatusCode METHOD_NOT_ALLOWED()
 * @method static StatusCode NOT_ACCEPTABLE()
 * @method static StatusCode PROXY_AUTHENTICATION_REQUIRED()
 * @method static StatusCode REQUEST_TIMEOUT()
 * @method static StatusCode CONFLICT()
 * @method static StatusCode GONE()
 * @method static StatusCode LENGTH_REQUIRED()
 * @method static StatusCode PRECONDITION_FAILED()
 * @method static StatusCode REQUEST_ENTITY_TOO_LARGE()
 * @method static StatusCode REQUEST_URI_TOO_LONG()
 * @method static StatusCode UNSUPPORTED_MEDIA_TYPE()
 * @method static StatusCode REQUESTED_RANGE_NOT_SATISFIABLE()
 * @method static StatusCode EXPECTATION_FAILED()
 * @method static StatusCode IM_A_TEAPOT()
 * @method static StatusCode MISDIRECTED_REQUEST()
 * @method static StatusCode UNPROCESSABLE_ENTITY()
 * @method static StatusCode LOCKED()
 * @method static StatusCode FAILED_DEPENDENCY()
 * @method static StatusCode UPGRADE_REQUIRED()
 * @method static StatusCode PRECONDITION_REQUIRED()
 * @method static StatusCode TOO_MANY_REQUESTS()
 * @method static StatusCode REQUEST_HEADER_FIELDS_TOO_LARGE()
 * @method static StatusCode LOGIN_TIMEOUT()
 * @method static StatusCode NO_RESPONSE()
 * @method static StatusCode RETRY_WITH()
 * @method static StatusCode BLOCKED_BY_WINDOWS_PARENTAL_CONTROLS()
 * @method static StatusCode UNAVAILABLE_FOR_LEGAL_REASONS()
 * @method static StatusCode REDIRECT()
 * @method static StatusCode REQUEST_HEADER_TOO_LARGE()
 * @method static StatusCode CERT_ERROR()
 * @method static StatusCode NO_CERT()
 * @method static StatusCode HTTP_TO_HTTPS()
 * @method static StatusCode TOKEN_EXPIRED_INVALID()
 * @method static StatusCode CLIENT_CLOSED_REQUEST()
 * @method static StatusCode TOKEN_REQUIRED()
 * @method static StatusCode INTERNAL_SERVER_ERROR()
 * @method static StatusCode NOT_IMPLEMENTED()
 * @method static StatusCode BAD_GATEWAY()
 * @method static StatusCode SERVICE_UNAVAILABLE()
 * @method static StatusCode GATEWAY_TIMEOUT()
 * @method static StatusCode HTTP_VERSION_NOT_SUPPORTED()
 * @method static StatusCode VARIANT_ALSO_NEGOTIATES()
 * @method static StatusCode INSUFFICIENT_STORAGE()
 * @method static StatusCode LOOP_DETECTED()
 * @method static StatusCode BANDWIDTH_LIMIT_EXCEEDED()
 * @method static StatusCode NOT_EXTENDED()
 * @method static StatusCode NETWORK_AUTHENTICATION_REQUIRED()
 * @method static StatusCode UNKNOWN_ERROR()
 * @method static StatusCode WEB_SERVER_IS_DOWN()
 * @method static StatusCode CONNECTION_TIMED_OUT()
 * @method static StatusCode ORIGIN_IS_UNREACHABLE()
 * @method static StatusCode A_TIMEOUT_OCCURRED()
 * @method static StatusCode SSL_HANDSHAKE_FAILED()
 * @method static StatusCode INVALID_SSL_CERTIFICATE()
 * @method static StatusCode RAILGUN_ERROR()
 * 
 * @version 0.9.0
 * 
 * @package Http
