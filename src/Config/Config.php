...
use Countable;
use Iterator;
use Inane\Config\Exception\InvalidArgumentException;
use Inane\Config\Exception\RuntimeException;
...
class Config implements Countable, Iterator, ArrayAccess {
    ...
    public function __set($name, $value) {
        if ($this->allowModifications) {
            if (is_array($value)) $value = new static($value, true);

            if (null === $name) $this->data[] = $value;
    ...
    /**
     * Deep clone of this instance to ensure that nested iEnv\App\Configs are also
     * cloned.
     *
     * @return void
     */
    public function __clone() {
        ...
        foreach ($this->data as $key => $value) if ($value instanceof self) $array[$key] = clone $value;
    ...
    public function setReadOnly() {
        ...
        /** @var Config $value */
        foreach ($this->data as $value) if ($value instanceof self) $value->setReadOnly();
    }
