...
class Secret {
    ...
    public function __construct(
        ...
        if (!in_array($this->cipher, openssl_get_cipher_methods())) throw new InvalidArgumentException("Invalid chiper method: '{$this->cipher}'");
    }
...
// Testing
// $o = 'This is a test!';
// $m = new Secret('D01587AD-CFB8-4323-8E4C-B2226CC04A11');
// $e = $m->encryptEncode($o);
// echo "$e\n";
// $d = $m->decryptDecode($e);
// echo "$d\n";
